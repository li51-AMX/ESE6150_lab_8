...
class MPC(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info(f"Loading waypoints")
        self.waypoint_file = 'waypoints.csv'
    ...
    def odom_callback(self, odom_msg):
        self.get_logger().info("odom_callback triggered")
        ...
        self.get_logger().info(f"x0: {x0}")  # check state looks reasonable
        ...
        if self.oa is not None:
            ...
            self.get_logger().info(f"published speed: {drive_msg.drive.speed}, steer: {drive_msg.drive.steering_angle}")
        else:
